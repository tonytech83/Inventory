...
class TestDevice(TestCase):
    ...
    def test_validate_no_special_characters__raises_validation_error(self):
        ...
        # organization = Organization.objects.create(organization_name="A")
        # business = Business.objects.create(business_name='B', country='C', organization=organization, owner=user)

        device = Device(device_name='test', business=self.business, operating_system='@')
    ...
    def test_validate_po_number__with_valid_number(self):
        ...
        device = Device(device_name='test', business=self.business, purchase_order_number=po_number)
        device.full_clean()
