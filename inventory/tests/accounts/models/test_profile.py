...
class TestProfile(TestCase):
    ...
    def test_first_name__with_non_alphabetical_characters__expects_validation_error(self):
        new_user = UserModel.objects.create_user(email="first@first.com", password="pass123")
    ...
    def test_last_name__with_non_alphabetical_characters__expects_validation_error(self):
        new_user = UserModel.objects.create_user(email="first@first.com", password="pass123")
