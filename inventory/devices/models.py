...
from inventory.devices.validators import (
...
class Device(TimeStampedModel, models.Model):
    ...
    domain = models.CharField(
        ...
        validators=(MinLengthValidator(MIN_DOMAIN_LENGTH),),
        null=True,
        blank=True,
    )
    ...
    manufacturer = models.CharField(
        ...
        validators=(MinLengthValidator(MIN_MANUFACTURER_LENGTH),),
        null=True,
        blank=True,
    )
    ...
    serial_number = models.CharField(
        ...
        validators=(MinLengthValidator(MIN_SERIAL_NUMBER_LENGTH),),
        unique=True,
        null=False,
        blank=False,
    )
    ...
    business_processes_at_risk = models.TextField(
        ...
        validators=(MinLengthValidator(MIN_BUSINESS_LENGTH),),
    ...
    support_model = models.TextField(
        ...
        validators=(MinLengthValidator(MIN_SUPPORT_LENGTH),),
    ...
    purchase_order_number = models.IntegerField(
        validators=(purchase_order_number_validator,),
        null=True,
        blank=True,
    )
    ...
    owner_name = models.CharField(
        max_length=MAX_NAME_LENGTH,
        validators=(MinLengthValidator(MIN_OWNER_NAME_LENGTH),),
        default="Unknown",
        null=True,
        blank=True,
    )
    ...
    def is_reviewed(self):
        return self.days_since_update < 365
