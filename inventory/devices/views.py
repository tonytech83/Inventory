...
class DeviceCreateAPIView(api_views.CreateAPIView):
    ...
    def get_serializer_context(self):
        ...
        context.update({"business_id": self.kwargs.get("business_id")})
        return context
...
class CSVUploadApiView(APIView):
    ...
    def post(self, request, business_id, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(
                {"message": "Devices imported successfully.", "results": results},
...
def download_template(request):
    ...
    template_path = os.path.join(
        settings.BASE_DIR, "staticfiles", "template_file", "template.xlsx"
    )
